...
VALUES
    ('KH001', N'Nguyễn Văn A', N'123 Đường ABC, Hà Nội', '0987654321', 'nguyenvana@email.com'),
    ...
    ('KH009', N'Trịnh Văn I', N'901 Đường XYZ, Hà Nội', '0987654329', 'trinhvani@email.com'),
...
INSERT INTO chiTietDonHang (soHoaDon, giaBan, soLuong, mucGiamGia)
VALUES
    (1, 1500000, 5, 100000),
    (2, 1200000, 3, 60000),
    (3, 1000000, 4, 80000),
...
INSERT INTO tuyChon (soLuongSanPham, maSanPham, maMauSac, maKichThuoc, soHoaDon)
VALUES
    (5, 'SP001', 1, 1, 1),
    (3, 'SP002', 2, 2, 1),
    (4, 'SP003', 1, 1, 3),
