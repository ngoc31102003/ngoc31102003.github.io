USE QLBanHang
GO 
-- Chèn 15 bản ghi dữ liệu ngẫu nhiên cho bảng nhà cung cấp
...
-- Chèn dữ liệu ngẫu nhiên cho bảng loaiHang
...
GO 
DELETE FROM matHang;
-- Chèn dữ liệu ngẫu nhiên cho bảng matHang
...
-- Chèn dữ liệu ngẫu nhiên cho bảng nhanVien
...
-- Chèn dữ liệu ngẫu nhiên cho bảng khachHang
...
-- Chèn dữ liệu ngẫu nhiên cho bảng donDatHang
...
-- Chèn dữ liệu ngẫu nhiên cho bảng chiTietDonHang
